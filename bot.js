...
const RENDER_EXTERNAL_URL = process.env.RENDER_EXTERNAL_URL || 'https://grwm-shop.onrender.com';
...
// --- EXPRESS SERVER VA WEBHOOK SOZLAMASI ---
const app = express();
const PORT = process.env.PORT || 3000;
const WEBHOOK_PATH = `/telegram-webhook-${BOT_TOKEN.split(':')[0]}`;

// Telegraf webhook middleware'ini ulash
app.use(bot.webhookCallback(WEBHOOK_PATH));

app.get('/', (req, res) => {
  res.send('GRWM Shop Webhook Server Is Live!');
});

app.listen(PORT, async () => {
  console.log(`🌐 Server ${PORT}-portda ishga tushdi.`);
  
  // Telegram'ga Webhook URL manzilingizni ro'yxatdan o'tkazish
